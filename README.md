...
![架构演进](/.img/common/yudao-roadmap.png)
...
![开源项目对比](/.img/common/project-vs.png)
...
![功能分层](/.img/common/ruoyi-vue-pro-biz.png)
...
| BPMN 设计器                     | 钉钉/飞书设计器                       |
|------------------------------|--------------------------------|
| ![](/.img/工作流设计器-bpmn.jpg) | ![](/.img/工作流设计器-simple.jpg) |
...
![功能图](/.img/common/mall-feature.png)

![功能图](/.img/common/mall-preview.png)
...
![功能图](/.img/common/erp-feature.png)

### CRM 系统

演示地址：<https://doc.iocoder.cn/crm-preview/>

![功能图](/.img/common/crm-feature.png)

### AI 大模型

演示地址：<https://doc.iocoder.cn/ai-preview/>

![功能图](/.img/common/ai-feature.png)

![功能图](/.img/common/ai-preview.gif)
...
| 模块       | biu                         | biu                       | biu                      |
|----------|-----------------------------|---------------------------|--------------------------|
| 登录 & 首页  | ![登录](/.img/登录.jpg)       | ![首页](/.img/首页.jpg)     | ![个人中心](/.img/个人中心.jpg) |
| 用户 & 应用  | ![用户管理](/.img/用户管理.jpg)   | ![令牌管理](/.img/令牌管理.jpg) | ![应用管理](/.img/应用管理.jpg) |
| 租户 & 套餐  | ![租户管理](/.img/租户管理.jpg)   | ![租户套餐](/.img/租户套餐.png) | -                        |
| 部门 & 岗位  | ![部门管理](/.img/部门管理.jpg)   | ![岗位管理](/.img/岗位管理.jpg) | -                        |
| 菜单 & 角色  | ![菜单管理](/.img/菜单管理.jpg)   | ![角色管理](/.img/角色管理.jpg) | -                        |
| 审计日志     | ![操作日志](/.img/操作日志.jpg)   | ![登录日志](/.img/登录日志.jpg) | -                        |
| 短信       | ![短信渠道](/.img/短信渠道.jpg)   | ![短信模板](/.img/短信模板.jpg) | ![短信日志](/.img/短信日志.jpg) |
| 字典 & 敏感词 | ![字典类型](/.img/字典类型.jpg)   | ![字典数据](/.img/字典数据.jpg) | ![敏感词](/.img/敏感词.jpg)  |
| 错误码 & 通知 | ![错误码管理](/.img/错误码管理.jpg) | ![通知公告](/.img/通知公告.jpg) | -                        |

### 工作流程

| 模块      | biu                             | biu                             | biu                             |
|---------|---------------------------------|---------------------------------|---------------------------------|
| 流程模型    | ![流程模型-列表](/.img/流程模型-列表.jpg) | ![流程模型-设计](/.img/流程模型-设计.jpg) | ![流程模型-定义](/.img/流程模型-定义.jpg) |
| 表单 & 分组 | ![流程表单](/.img/流程表单.jpg)       | ![用户分组](/.img/用户分组.jpg)       | -                               |
| 我的流程    | ![我的流程-列表](/.img/我的流程-列表.jpg) | ![我的流程-发起](/.img/我的流程-发起.jpg) | ![我的流程-详情](/.img/我的流程-详情.jpg) |
| 待办 & 已办 | ![任务列表-审批](/.img/任务列表-审批.jpg) | ![任务列表-待办](/.img/任务列表-待办.jpg) | ![任务列表-已办](/.img/任务列表-已办.jpg) |
| OA 请假   | ![OA请假-列表](/.img/OA请假-列表.jpg) | ![OA请假-发起](/.img/OA请假-发起.jpg) | ![OA请假-详情](/.img/OA请假-详情.jpg) |

### 基础设施

| 模块            | biu                           | biu                         | biu                       |
|---------------|-------------------------------|-----------------------------|---------------------------|
| 代码生成          | ![代码生成](/.img/代码生成.jpg)     | ![生成效果](/.img/生成效果.jpg)   | -                         |
| 文档            | ![系统接口](/.img/系统接口.jpg)     | ![数据库文档](/.img/数据库文档.jpg) | -                         |
| 文件 & 配置       | ![文件配置](/.img/文件配置.jpg)     | ![文件管理](/.img/文件管理2.jpg)  | ![配置管理](/.img/配置管理.jpg) |
| 定时任务          | ![定时任务](/.img/定时任务.jpg)     | ![任务日志](/.img/任务日志.jpg)   | -                         |
| API 日志        | ![访问日志](/.img/访问日志.jpg)     | ![错误日志](/.img/错误日志.jpg)   | -                         |
| MySQL & Redis | ![MySQL](/.img/MySQL.jpg)   | ![Redis](/.img/Redis.jpg) | -                         |
| 监控平台          | ![Java监控](/.img/Java监控.jpg) | ![链路追踪](/.img/链路追踪.jpg)   | ![日志中心](/.img/日志中心.jpg) |

### 支付系统

| 模块      | biu                       | biu                             | biu                             |
|---------|---------------------------|---------------------------------|---------------------------------|
| 商家 & 应用 | ![商户信息](/.img/商户信息.jpg) | ![应用信息-列表](/.img/应用信息-列表.jpg) | ![应用信息-编辑](/.img/应用信息-编辑.jpg) |
| 支付 & 退款 | ![支付订单](/.img/支付订单.jpg) | ![退款订单](/.img/退款订单.jpg)       | ---                             |
### 数据报表

| 模块    | biu                             | biu                             | biu                                   |
|-------|---------------------------------|---------------------------------|---------------------------------------|
| 报表设计器 | ![数据报表](/.img/报表设计器-数据报表.jpg) | ![图形报表](/.img/报表设计器-图形报表.jpg) | ![报表设计器-打印设计](/.img/报表设计器-打印设计.jpg) |
| 大屏设计器 | ![大屏列表](/.img/大屏设计器-列表.jpg)   | ![大屏预览](/.img/大屏设计器-预览.jpg)   | ![大屏编辑](/.img/大屏设计器-编辑.jpg)         |

### 移动端（管理后台）

| biu                              | biu                              | biu                              |
|----------------------------------|----------------------------------|----------------------------------|
| ![](/.img/admin-uniapp/01.png) | ![](/.img/admin-uniapp/02.png) | ![](/.img/admin-uniapp/03.png) |
| ![](/.img/admin-uniapp/04.png) | ![](/.img/admin-uniapp/05.png) | ![](/.img/admin-uniapp/06.png) |
| ![](/.img/admin-uniapp/07.png) | ![](/.img/admin-uniapp/08.png) | ![](/.img/admin-uniapp/09.png) |
